...
<code>Note: This version of project uses built-in web [MutationObserver](https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver) implementation to catch ads on the websites.</code>
